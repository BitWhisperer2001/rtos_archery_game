...
typedef struct {
    ...
    /*
     * A 32-bit score prevents silent wrap-around during long soak tests and
     * matches the persistent journal's on-Flash representation.
     */
    uint32_t game_score;
    uint32_t last_game_score;
